  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 tracking-tight backdrop-blur-sm">
      <div className="max-w-2xl mx-4 lg:mx-auto px-2 md:px-0">
        <nav
          className="flex flex-row items-center justify-between py-3 -ml-[8px] min-w-0"
          id="nav"
        >
          <div className="flex flex-row space-x-0 min-w-0">
          ...
          <div className="flex flex-row space-x-2">
            ...
            <a
              href="https://www.linkedin.com/in/ekagra-luthra/"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex align-middle relative p-1"
              aria-label="LinkedIn"
            ...
            <a
              href="mailto:ekluthra@yahoo.com"
              className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex align-middle relative p-1"
              aria-label="Email"
            >
              <EmailIcon />
